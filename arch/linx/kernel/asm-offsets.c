...
void asm_offsets(void)
{
	...
	OFFSET(PT_TPC, pt_regs, tpc);
	OFFSET(PT_BPC, pt_regs, bpc);
	OFFSET(PT_BPCN, pt_regs, bpcn);
	OFFSET(PT_EBARG, pt_regs, ebarg);
	OFFSET(PT_ELPR0, pt_regs, elpr0);
	OFFSET(PT_ELPR1, pt_regs, elpr1);
	OFFSET(PT_ELPR2, pt_regs, elpr2);
	OFFSET(PT_ELPR3, pt_regs, elpr3);
	OFFSET(PT_ELPR4, pt_regs, elpr4);
	OFFSET(PT_ELPR5, pt_regs, elpr5);
	OFFSET(PT_ELPR6, pt_regs, elpr6);
	OFFSET(PT_ELPR7, pt_regs, elpr7);
	...
	OFFSET(PT_X0, pt_regs, x0);
	OFFSET(PT_X1, pt_regs, x1);
	OFFSET(PT_X2, pt_regs, x2);
	OFFSET(PT_X3, pt_regs, x3);
	OFFSET(PT_GP, pt_regs, gp);	/* non-BSTATE registers */
	OFFSET(PT_TP, pt_regs, tp);
	OFFSET(PT_CSTATE, pt_regs, cstate);
	OFFSET(PT_TRAPARG0, pt_regs, traparg0);
	OFFSET(PT_TRAPNO, pt_regs, trapno);
	OFFSET(PT_ORIG_A0, pt_regs, orig_a0);
	OFFSET(PT_ORIG_BPC, pt_regs, orig_bpc);
	OFFSET(PT_ORIG_TPC, pt_regs, orig_tpc);
	...
	// DEFINE(EB_SIZE_ON_STACK, ALIGN(sizeof(struct ebstate), STACK_ALIGN));
