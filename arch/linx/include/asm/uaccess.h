...
#define __get_user_8(x, ptr, err) \
	__get_user_asm("ldi", x, ptr, err)
#else /* !CONFIG_64BIT */
#error "UNSUPPORT CONFIG_32BIT"
#endif /* CONFIG_64BIT */
...
do {								\
	...
	case 1:							\
		__get_user_asm("lbi", (x), __gu_ptr, __gu_err);	\
		break;						\
	case 2:							\
		__get_user_asm("lhi", (x), __gu_ptr, __gu_err);	\
		break;						\
	case 4:							\
		__get_user_asm("lwi", (x), __gu_ptr, __gu_err);	\
		break;						\
	case 8:							\
...
do {								\
	switch (sizeof(*__gu_ptr)) {				\
	case 1:							\
		__put_user_asm("sbi", (x), __gu_ptr, __pu_err);	\
		break;						\
	case 2:							\
		__put_user_asm("shi", (x), __gu_ptr, __pu_err);	\
		break;						\
	case 4:							\
		__put_user_asm("swi", (x), __gu_ptr, __pu_err);	\
		break;						\
	case 8:							\
