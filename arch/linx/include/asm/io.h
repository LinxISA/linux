...
#define __io_pbr()	__asm__ __volatile__ (ASM_FENCE_BLOCK(io, i) "" ::: "memory");
#define __io_par(v)	__asm__ __volatile__ (ASM_FENCE_BLOCK(i, ior) "" ::: "memory");
#define __io_pbw()	__asm__ __volatile__ (ASM_FENCE_BLOCK(iow, o) "" ::: "memory");
#define __io_paw()	__asm__ __volatile__ (ASM_FENCE_BLOCK(o, io) "" ::: "memory");
