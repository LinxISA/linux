...
def main() -> int:
    ...
    qemu_default_candidates = [
        pathlib.Path("/tmp/linx-qemu-clean-build/qemu-system-linx64"),
        super_root / "emulator" / "qemu" / "build" / "qemu-system-linx64",
        super_root / "emulator" / "qemu" / "build-tci" / "qemu-system-linx64",
        pathlib.Path.home() / "qemu" / "build" / "qemu-system-linx64",
        pathlib.Path.home() / "qemu" / "build-tci" / "qemu-system-linx64",
    ]
