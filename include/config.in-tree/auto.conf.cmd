...
ifneq "$(KERNELVERSION)" "6.18.8"
$(autoconfig): FORCE
endif

ifneq "$(CC)" "/Users/zhoubot/llvm-project/build-linxisa-clang/bin/clang"
$(autoconfig): FORCE
endif

ifneq "$(LD)" "/Users/zhoubot/llvm-project/build-linxisa-clang/bin/ld.lld"
$(autoconfig): FORCE
endif
...
ifneq "$(CLANG_FLAGS)" "--target=linx64-unknown-linux-gnu -fintegrated-as -Werror=unknown-warning-option -Werror=ignored-optimization-argument -Werror=option-ignored -Werror=unused-command-line-argument"
$(autoconfig): FORCE
endif
...
ifneq "$(CC_VERSION_TEXT)" "clang version 23.0.0git (git@github.com:zhoubot/llvm-project.git e5b345fadc427ae00269a51365553f014b4a41d3)"
$(autoconfig): FORCE
endif
