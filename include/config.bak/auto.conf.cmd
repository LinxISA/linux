...
ifneq "$(CLANG_FLAGS)" "--target=linx64-linx-none-elf -fintegrated-as -Werror=unknown-warning-option -Werror=ignored-optimization-argument -Werror=option-ignored -Werror=unused-command-line-argument"
$(autoconfig): FORCE
endif
...
ifneq "$(CC_VERSION_TEXT)" "clang version 23.0.0git (git@github.com:zhoubot/llvm-project.git cfc6dd5711dcb22eac664da55e1a011c1a49b548)"
$(autoconfig): FORCE
endif
